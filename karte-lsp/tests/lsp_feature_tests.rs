...
#[test]
fn test_analyze_valid_v72_scale() {
    let mut bridge = CompilerBridge::new();
    let source = "enum Scale3 { Major, Minor3, Pentatonic, Blues }\nfn has_seven_notes(s: Scale3) -> bool {\nmatch s {\nScale3::Major => true\nScale3::Minor3 => true\nScale3::Pentatonic => false\nScale3::Blues => false\n}\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
    assert!(errors.is_empty(), "Should have no errors: {:?}", errors);
}
...
#[test]
fn test_analyze_valid_v72_odd_cube() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v72_cond_sq() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v72_range_70_90() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet sum = 0;\nfor i in 0..x {\nif i > 70 && i < 90 {\nsum = sum + i\n}\n};\nsum\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v72_option_fourth() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v72_result_seg() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v72_expand() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet a = x + 6;\nlet b = a * a - 36;\nb\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v73_cone() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v73_day() {
    let mut bridge = CompilerBridge::new();
    let source = "enum Day2 { Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday }\nfn is_weekend(d: Day2) -> bool {\nmatch d {\nDay2::Saturday => true\nDay2::Sunday => true\n_ => false\n}\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
    assert!(errors.is_empty(), "Should have no errors: {:?}", errors);
}
...
#[test]
fn test_analyze_valid_v73_quad_sum() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet sum = 0;\nfor i in 0..x {\nsum = sum + (i * i + i)\n};\nsum\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v73_fib_35() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet a = 3;\nlet b = 5;\nfor i in 0..x {\nlet c = a + b;\na = b;\nb = c\n};\nb\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v73_offset() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet sum = 0;\nfor i in 0..x {\nif i > 80 {\nsum = sum + (i - 80) * 3\n}\n};\nsum\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v73_option_eleventh() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v73_result_overflow() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v73_expand() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet a = x * 2 + 7;\nlet b = a * a - 49;\nb\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v75_flavor() {
    let mut bridge = CompilerBridge::new();
    let source = "enum Flavor { Sweet, Sour, Salty, Bitter, Umami }\nfn is_savory(f: Flavor) -> bool {\nmatch f {\nFlavor::Sweet => false\nFlavor::Sour => false\nFlavor::Salty => true\nFlavor::Bitter => false\nFlavor::Umami => true\n}\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
    assert!(errors.is_empty(), "Should have no errors: {:?}", errors);
}
...
#[test]
fn test_analyze_valid_v75_planet() {
    let mut bridge = CompilerBridge::new();
    let source = "enum Planet { Mercury, Venus, Earth, Mars, Jupiter, Saturn }\nfn is_rocky(p: Planet) -> bool {\nmatch p {\nPlanet::Mercury => true\nPlanet::Venus => true\nPlanet::Earth => true\nPlanet::Mars => true\nPlanet::Jupiter => false\nPlanet::Saturn => false\n}\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
    assert!(errors.is_empty(), "Should have no errors: {:?}", errors);
}
...
#[test]
fn test_analyze_valid_v75_cube_expand() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v75_fib_7_11() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet a = 7;\nlet b = 11;\nfor i in 0..x {\nlet c = a + b;\na = b;\nb = c\n};\nb\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v75_offset_100() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet sum = 0;\nfor i in 0..x {\nif i > 100 {\nsum = sum + (i - 100) * (i - 100)\n}\n};\nsum\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v75_option_13() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v75_result_7x() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v75_expand() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet a = x * 4 + 3;\nlet b = a * a - 9;\nb\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v76_cross() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet sum = 0;\nfor i in 0..x {\nsum = sum + (i * 2 + 1) * (i + 1)\n};\nsum\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v76_cond_while() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v76_range_sq() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet sum = 0;\nfor i in 0..x {\nif i > 10 && i < 20 {\nsum = sum + (i - 10) * (i - 10)\n}\n};\nsum\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
...
#[test]
fn test_analyze_valid_v76_option_14() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v76_result_8x() {
    let mut bridge = CompilerBridge::new();
...
#[test]
fn test_analyze_valid_v76_expand() {
    let mut bridge = CompilerBridge::new();
    let source = "fn f(x: number) -> number {\nlet a = x * 5 + 4;\nlet b = a * a - 16;\nb\n}";
    let diagnostics = bridge.analyze(source);
    let errors: Vec<_> = diagnostics.iter().filter(|d| d.severity == KarteDiagnosticSeverity::Error).collect();
